...
print(len(X_train))
print("The length of test data set is ", len(X_test))
...
print("The mean square error is %.2f"%mean_squared_error(Y_test, y_hat))
print("The mean absolute error is %.2f"%mean_absolute_error(Y_test, y_hat))
...
#plt.savefig("C:\\Users\\Subiran\\Desktop\\My Dataset\\DecisionTreeActVsPred.jpg")
#plt.show()
