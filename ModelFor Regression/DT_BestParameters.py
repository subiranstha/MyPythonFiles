...
regressor = DecisionTreeRegressor(splitter="best", max_depth=5, min_samples_leaf= 4, min_weight_fraction_leaf=0.1,
                                  max_features= "log2",max_leaf_nodes=10, random_state=0)
...
plt.savefig("C:\\Users\\Subiran\\Desktop\\My Dataset\\DecisionTreeActVsPredTunedParametersExplainedVariance.jpg")
plt.show()
